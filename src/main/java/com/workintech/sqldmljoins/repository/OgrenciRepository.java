...
public interface OgrenciRepository extends JpaRepository<Ogrenci, Long> {
    ...
    String QUESTION_8 = "select o.sinif,count(o.*) from ogrenci o group by o.sinif";
    @Query(value = QUESTION_8, nativeQuery = true)
    List<StudentClassCount> findStudentClassCount();

    String QUESTION_9 = "select o.ad, o.soyad, count(i.kitapno) from ogrenci o inner join islem i on o.ogrno=i.ogrno " +
